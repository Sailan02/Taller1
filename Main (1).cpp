...
bool seguirEjecutando() { //Despues de realizar la accion que desea, le pregunta si quiere seguir o irse
    ...
    while (true) {
        cout << "Deseas Seguir? (si/no)" << endl;
        cin >> seguir;

        if (seguir == "si") {
            return true;
        } else if (seguir == "no") {
            cout << "Nos vemos bro" << endl;
            return false;
        } else {
            cout << "Entrada no válida. Por favor, ingresa 'si' o 'no'." << endl;
        }
    }
}
...
void realizarOfimatica(Ofimatica* ofima){// realizar el metodo unico de ofimatica
    ...
    cin >> opcion;
     switch (opcion) {
            case 1: {
                cout << "Un archivo aregado." << endl;
                ofima->agregarcantidad(1);
                break;
            }
            case 2: {
                cout << "Un archivo eliminado." << endl;
...
void menuADM(Administrador* adm){//menu del adm
    while(true){
        ...
        cout << "1. Descargar juego" << endl;
        cout << "2. Descargar software de ofimática" << endl;
        cout << "3. Descargar software de producción" << endl;
        cout << "4. Descargar navegador" << endl;
        cout << "5. Descargar software de seguridad" << endl;
        cout << "6. Descargar software social" << endl;
        cout << "7. Agregar amig@s" << endl;
        cout << "8. Eliminar amig@s" << endl;
        cout << "9. Ver amigos" << endl;
        cout << "Ingrese el número de la opción deseada: ";
    
        cin >> opcion;
        string nombreaplicaion;
        ...
        switch (opcion) {
             case 1:
                ...
                if (aplicaionencontrada) {
                    cout << "Descargando juego..." << endl;
                break;  
                } else {
                cout << "Opción no válida. Por favor, ingresa un nombre de juego válido." << endl;
                }
            }
            break;
        ...
        case 2:
            while (true) {
                ...
                cout << "Opción no válida. Por favor, ingresa un nombre de un software válido." << endl;
                }
            }
            break;
        case 3:
            ...
            while (true) {
                ...
                if (aplicaionencontrada) {
                    cout << "Descargando software..." << endl;
                break;  
                } else {
                cout << "Opción no válida. Por favor, ingresa un nombre de un software válido." << endl;
                }
        ...
        case 4:
            ...
            while (true) {
                ...
                if (aplicaionencontrada) {
                    cout << "Descargando navegador..." << endl;
                break;  
                } else {
                cout << "Opción no válida. Por favor, ingresa un nombre de un navegador  válido." << endl;
                }
            }
            break;
        case 5:
        ...
        case 6:
            ...
            case 7:
                if(adm->getListaSoftwares().tieneSoftSocial()){
                    cout << "No puedes agregar amigos, ya que tu biblioteca de software esta vacia" << endl;
                    ...
                    while (true) {
                        ...
                        if (amigoencontrado) {
                            cout << "Amigo agregado" << endl;
                            break;  
                        } else {
                        cout << "Opción no válida. Por favor, ingresa un nombre  válido." << endl;
                            }   
                    }  
                }
             break;
              ...
              case 8:
                if(adm->mostraramigos().size()==0){
                    cout << "No puedes eliminar amigos, ya que no tienes" << endl;
...
void menunormal(UsuarioNormal* user){//menu del usuario normal
    while(true){
        ...
        cout << "Bienvenido al Menú de Usuario Normal" << endl;
        cout << "1. Descargar juego" << endl;
        cout << "2. Descargar software de ofimática" << endl;
        cout << "3. Descargar software de producción" << endl;
        cout << "4. Descargar navegador" << endl;
        cout << "5. Descargar software social" << endl;
        cout << "6. Agregar amig@s" << endl;
        cout << "7. Eliminar amig@s" << endl;
        cout << "8. Ver amigos" << endl;
        cout << "Ingrese el número de la opción deseada: ";
        ...
        case 5:
            ...
            case 6:
                if(user->getListaSoftwares().tieneSoftSocial()){
                    cout << "No tiene un APP Social" << endl;
...
void menujoven(Joven* joven){//menu del usuario niño
    ...
    while(true){
        ...
        cout << "Bienvenido al Menú de Joven" << endl;
        cout << "1. Descargar juego" << endl;
        cout << "2. Descargar software de ofimática" << endl;
        cout << "3. Descargar software de Producción" << endl;
        cout << "4. Descargar Navegador" << endl;
        cout << "5. Descargar Facebook" << endl;
        cout << "6. Agregar amig@s" << endl;
        cout << "7. Eliminar amig@s" << endl;
        cout << "8. Ver amig@s" << endl;
        cout << "Ingrese el número de la opción deseada: ";
        ...
        case 5:
            ...
            case 6:
                if(joven->getListaSoftwares().tieneSoftSocial()){
                    cout << "No tiene una  APP Social"<< endl;
                    

                }else{
                    while (true) {
                         cout << "Que quien deseas agregar: "<< endl;
             ...
             break;
              ...
              case 7:
                if(joven->mostraramigos().size()==0){
                     ...
                     while (true) {
                        cout << "Quien deseas eliminar: "<< endl;
...
//agregar amigos
usuario1->agregaramigos(usuario2); nino1->agregaramigos(nino2);nino2->agregaramigos(nino1);nino2->agregaramigos(nino4);nino4->agregaramigos(nino2);
usuario3->agregaramigos(usuario4); nino1->agregaramigos(nino3);nino3->agregaramigos(nino1);nino3->agregaramigos(nino4);nino4->agregaramigos(nino3);
usuario5->agregaramigos(usuario6); 
usuario7->agregaramigos(usuario8); 
usuario9->agregaramigos(usuario10);
usuario2->agregaramigos(usuario1); 
usuario4->agregaramigos(usuario3); 
usuario6->agregaramigos(usuario5); 
usuario8->agregaramigos(usuario7); 
usuario10->agregaramigos(usuario9);
usuario1->agregaramigos(usuario3);
usuario3->agregaramigos(usuario5);
usuario5->agregaramigos(usuario7);
usuario7->agregaramigos(usuario9);
usuario9->agregaramigos(usuario1);
usuario2->agregaramigos(usuario4);
usuario4->agregaramigos(usuario6);
usuario6->agregaramigos(usuario8);
usuario8->agregaramigos(usuario10);
usuario10->agregaramigos(usuario2);
usuario3->agregaramigos(usuario1);
usuario5->agregaramigos(usuario3);
usuario7->agregaramigos(usuario5);
usuario9->agregaramigos(usuario7);
usuario1->agregaramigos(usuario9);
usuario4->agregaramigos(usuario2);
usuario6->agregaramigos(usuario4);
usuario8->agregaramigos(usuario6);
usuario10->agregaramigos(usuario8);
usuario2->agregaramigos(usuario10);
